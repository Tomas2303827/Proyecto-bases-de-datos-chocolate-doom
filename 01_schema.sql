...
-- Registro atómico de telemetría: una muestra (tic) de una participación.
...
-- Q5: hotspot por celda 250x250 calculada desde (pos_x, pos_y).
-- La telemetria NO referencia Sector; el "sector" analitico es una celda
-- matematica, asi que se indexa la expresion de la celda.
CREATE INDEX IF NOT EXISTS idx_tel_cell
